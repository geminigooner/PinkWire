...
import { Search, Grid, LayoutGrid, Square, Film, Image as ImageIcon, Play } from 'lucide-react';
import { cn } from '../../../../utils/cn';

export function Toolbar() {
  const { searchQuery, setSearchQuery, viewMode, setViewMode, toggleSlideshow, slideshowActive } = useDisposableStore();
      ...
      <div className="flex items-center gap-2">
        <div className="relative">
          ...
          <input
            ...
            className="w-48 bg-black/40 border border-os-window-border rounded-full pl-9 pr-4 py-1.5 text-xs text-os-text placeholder:text-os-text-muted focus:outline-none focus:border-os-accent/50 focus:ring-1 focus:ring-os-accent/50 transition-all"
          />
        </div>
      </div>
