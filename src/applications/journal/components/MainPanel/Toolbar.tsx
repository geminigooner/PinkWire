    ...
    <div className="h-14 shrink-0 border-b border-os-window-border bg-os-titlebar-bg/70 px-4 flex items-center justify-between">
      <div className="flex items-center gap-2">
        ...
        {(activeArticleId || isEditing) && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-os text-sm font-medium text-os-text-muted hover:text-os-text hover:bg-white/10 transition-colors"
          >
            <ChevronLeft size={16} />
            Back
          </button>
        ...
        <div className="flex items-center gap-3">
          {isAuthenticated && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-os text-xs font-medium text-os-accent border border-os-accent/30 hover:bg-os-accent hover:text-white transition-colors"
              title="Edit Post"
            >
              <Edit size={14} />
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-os text-xs font-medium text-os-text-muted hover:text-os-text hover:bg-white/10 transition-colors border border-transparent"
      ...
      {isEditing && (
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => saveDraft()}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-os text-xs font-medium text-os-text border border-os-window-border hover:bg-white/10 transition-colors"
          >
            <Save size={14} />
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-os text-xs font-medium bg-os-accent text-white hover:bg-pink-600 transition-colors shadow-[0_0_10px_rgba(236,72,153,0.3)]"
          >
            <Check size={14} />
