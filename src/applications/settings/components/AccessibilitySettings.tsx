      ...
      <div>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="bg-black/20 border border-os-window-border rounded-xl p-4 space-y-2">
              <button
                onClick={() => setReducedMotion(!reducedMotion)}
                className="w-full flex items-center justify-between text-sm text-os-text hover:bg-white/5 p-3 rounded-lg transition-colors"
              >
          ...
          <section>
            ...
            <div className="bg-black/20 border border-os-window-border rounded-xl p-6">
              <div className="mb-6">
                  ...
                  {cursors.map(c => (
                    <button
                      ...
                      className={cn(
                        ...
                        cursor === c.id 
                          ? "bg-os-accent/20 border-os-accent text-os-accent shadow-inner" 
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center bg-black/40 border border-os-window-border rounded-lg p-1 w-max">
              ...
              <div className="pt-4 border-t border-os-window-border">
                <button
                  ...
                  className="w-full flex items-center justify-between text-sm text-os-text hover:bg-white/5 p-2 -mx-2 rounded-lg transition-colors"
                >
