...
export function StartMenuQuickActions({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="shrink-0 bg-black/20 p-3 rounded-os border border-white/5 grid grid-cols-4 gap-2">
      <button 
        onClick={() => handleAction(() => openWindow('settings'))}
        className="flex flex-col items-center justify-center h-[72px] rounded-os hover:bg-white/10 transition-colors gap-1.5 text-os-text-muted hover:text-os-text"
      >
        <div className="p-2 bg-black/30 rounded-full shadow-os border border-white/5">
          <Settings size={18} />
        </div>
      ...
      <button 
        ...
        className="flex flex-col items-center justify-center h-[72px] rounded-os hover:bg-white/10 transition-colors gap-1.5 text-os-text-muted hover:text-red-400 group"
      >
        <div className="p-2 bg-black/30 rounded-full shadow-os border border-white/5 group-hover:bg-red-500/20 group-hover:border-red-500/50 transition-colors">
          <Power size={18} />
        </div>
