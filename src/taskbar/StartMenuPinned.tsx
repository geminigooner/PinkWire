        ...
        {pinnedApps.map(appId => {
          ...
          return (
            <button
              ...
              className="flex flex-col items-center gap-2 p-2 hover:bg-white/10 rounded-2xl transition-all group active:scale-95"
            >
              <div className="w-12 h-12 bg-black/30 rounded-xl flex items-center justify-center shadow-lg border border-white/10 group-hover:border-os-accent/50 group-hover:bg-black/40 transition-all relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                <app.icon size={24} className="text-os-accent drop-shadow-md group-hover:scale-110 transition-transform duration-300" />
              </div>
